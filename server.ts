...
const FALLBACK_MOVIES: Record<string, any[]> = {
  ...
  "thriller": [
    { title: "Oxygen", year: "2021", rating: "6.5", duration: "101 min", plot: "A woman wakes up in a cryogenic chamber with no memory. She must find a way out before she runs out of air.", director: "Alexandre Aja", actors: "Mélanie Laurent, Mathieu Amalric", posterUrl: "assets/15690db0a4b1d33c52dcdedd36d610562d54858c.png" },
    { title: "Smile", year: "2022", rating: "6.7", duration: "115 min", plot: "After witnessing a bizarre, traumatic incident involving a patient, Dr. Rose Cotter starts experiencing frightening occurrences that she can't explain.", director: "Parker Finn", actors: "Sosie Bacon, Kyle Gallner", posterUrl: "assets/3455fb7fe955be1f9a7904719c8a745034b5181b.png" },
    { title: "The Gray Man", year: "2022", rating: "6.5", duration: "122 min", plot: "When the CIA's most skilled mercenary accidentally uncovers dark agency secrets, he becomes a primary target, hunted by international assassins.", director: "Anthony Russo, Joe Russo", actors: "Ryan Gosling, Chris Evans", posterUrl: "assets/0c292f2d54f9b6a5cf219bb8f700573f82e63f7e.png" },
    { title: "The Menu", year: "2022", rating: "7.2", duration: "107 min", plot: "A young couple travels to a remote island to eat at an exclusive restaurant where the chef has prepared a lavish menu, with some shocking surprises.", director: "Mark Mylod", actors: "Ralph Fiennes, Anya Taylor-Joy", posterUrl: "assets/6e0199262805c9434f0cec642dd4b70535e89824.png" }
  ],
  "western": [
  ...
  "horror": [
    { title: "M3GAN", year: "2022", rating: "6.4", duration: "102 min", plot: "A robotics engineer at a toy company builds a life-like doll that begins to take on a life of its own.", director: "Gerard Johnstone", actors: "Allison Williams, Violet McGraw", posterUrl: "assets/c8a7c0a244137c10b285dbe9001b17d21d3be573.png" },
    { title: "The Invitation", year: "2022", rating: "5.3", duration: "105 min", plot: "A young woman is courted and swept off her feet, only to realize a gothic conspiracy is afoot.", director: "Jessica M. Thompson", actors: "Nathalie Emmanuel, Thomas Doherty", posterUrl: "assets/150491348f418ea7f1b35834e2a808cf0e0b633c.png" },
    { title: "Orphan: First Kill", year: "2022", rating: "5.9", duration: "99 min", plot: "After orchestrating a brilliant escape from an Estonian psychiatric facility, Esther travels to America by impersonating the missing daughter of a wealthy family.", director: "William Brent Bell", actors: "Isabelle Fuhrman, Julia Stiles", posterUrl: "assets/5c94852523a811b9a2d441498d6bc6955bad257f.png" },
    { title: "Ouija: Origin of Evil", year: "2016", rating: "6.2", duration: "99 min", plot: "In 1967 Los Angeles, a widowed mother and her daughters unwittingly invite authentic evil into their home by adding a new stunt to their seance business.", director: "Mike Flanagan", actors: "Elizabeth Reaser, Lulu Wilson", posterUrl: "assets/4f8a64498d3885b1164af52d08dbd1879f6f8c4d.png" }
  ],
  "fantasy": [
